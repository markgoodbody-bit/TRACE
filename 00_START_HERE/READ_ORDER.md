...
Status: stable repo navigation. Not validation. Not proof.

## Fast orientation

1. `README.md`
2. `00_START_HERE/IMPORT_MANIFEST.md`
3. `02_CURRENT_SURFACE/PUBLIC_ONE_SHEET_v0_2/TRACE_ME_PUBLIC_ONE_SHEET_v0_2.md`
4. `02_CURRENT_SURFACE/FRONT_DOOR_v0_3/TRACE_BOOTSTRAP_ROSETTA_CURRENT_FRONT_DOOR_v0_3.md`

## Structural spine

5. `01_CANONICAL_MEMORY/OPERATOR_REGISTRY/TRACE_OPERATOR_REGISTRY_v0_1.md`
...
10. `03_BOOTSTRAPS/ACTIVE_COLLECTION/02_SOURCE_MARKDOWN/`
...
Do not treat bootstraps as proof. Do not treat the Operator Registry as a replacement for the full artifacts.
