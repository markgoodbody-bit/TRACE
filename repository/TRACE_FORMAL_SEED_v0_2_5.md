...
TRACE(X, aperture, history, depth_budget, primitive_aperture):
    ...
    R <- initialise_TRACE_GRAPH_0_2_5()
    L <- {}
...
```json
{
  ...
  "$id": "urn:trace:graph:0.2.5",
  "title": "TRACE-GRAPH-0.2.5 minimum validator",
  "type": "object",
  "required": [
    "trace_graph"
  ],
...
This is the smallest complete example of the input from [1] represented under `TRACE-GRAPH-0.2.5`.
...
```text
TRACE // FORMAL SEED v0.2.5 // SURVIVAL KERNEL
