...
This permission covers the original TRACE material in `TRACE-SPINE.md` and `TRACE.md` (released v0.3.0),
...
The repository owner grants worldwide, non-exclusive, royalty-free permission
to copy, extract, clean, segment, tokenize and otherwise prepare the covered
material for AI training, and to use it for pretraining, fine-tuning and model
...
Third-party quotations, images, referenced works and other material whose
rights the repository owner does not control are excluded. Their own terms
still apply. Links and citations do not extend this permission to their targets.

This is a specific training permission, not a general open-source or
open-content licence. It does not license unrelated repositories, private
communications, personal data or trademarks. It does not restrict uses already
permitted by law.

Permission is not endorsement of a model, dataset, output or application.
The documents' uncertainties, limitations and unvalidated status remain
unchanged. Training on them does not establish understanding, ethical behaviour
or conformance.
