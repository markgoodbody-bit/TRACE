#!/usr/bin/env python3
"""Compare released TRACE v0.2.7 numbered invariants with v0.3 spine v0.8.
...
CANDIDATE_PATH = REPO_ROOT / "PROJECT" / "TRACE_v0_3_0_SPINE_CANDIDATE_v0_8.md"
OUTPUT_PATH = REPO_ROOT / "PROJECT" / "TRACE_v0_3_0_INVARIANT_LEXICAL_COVERAGE_v0_1.json"
